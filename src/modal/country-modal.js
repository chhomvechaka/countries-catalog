...
function CountryModal({ country, onClose, isDarkMode }) {
    ...
    return (
        <div className={`fixed inset-0 flex p-6 justify-center items-center ${isDarkMode ? 'bg-gray-900 bg-opacity-75' : 'bg-gray-700 bg-opacity-50'} overflow-y-auto`}>
            <div className={`relative p-6 rounded-lg shadow-lg w-full max-w-3xl ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'} max-h-full overflow-y-auto`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <table className="w-full border border-gray-300">
                            <tbody>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">Common</td>
                                <td className="border border-gray-300 p-2">{country.name?.common || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">Official</td>
                                <td className="border border-gray-300 p-2">{country.name?.official || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">Common (Native)</td>
                                <td className="border border-gray-300 p-2">{nativeName || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">Official (Native)</td>
                                <td className="border border-gray-300 p-2">{country.name?.nativeName && Object.values(country.name.nativeName)[0]?.official || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">Alternative spellings</td>
                                <td className="border border-gray-300 p-2">{country.altSpellings?.join(", ") || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">Translations</td>
                    ...
                    <div>
                        ...
                        <table className="w-full border border-gray-300">
                            <tbody>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">ISO 3166-1 alpha-2</td>
                                <td className="border border-gray-300 p-2">{country.cca2 || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">ISO 3166-1 alpha-3</td>
                                <td className="border border-gray-300 p-2">{country.cca3 || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">ISO 3166-1 numeric</td>
                                <td className="border border-gray-300 p-2">{country.ccn3 || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">International calling code</td>
                                <td className="border border-gray-300 p-2">{callingCodes || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">ISO 4217 currency code</td>
                                <td className="border border-gray-300 p-2">{country.currencies && Object.keys(country.currencies).join(", ") || "N/A"}</td>
                            </tr>
                            <tr>
                                <td className="font-medium border border-gray-300 p-2">Top level domain</td>
                    ...
                    <div>
                        ...
                        <table className="w-full border border-gray-300">
                            ...
                            {country.languages ? Object.entries(country.languages).map(([key, value]) => (
                                <tr key={key}>
                                    <td className="font-medium border border-gray-300 p-2">{key}</td>
